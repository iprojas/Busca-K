...
export const departments: DepartmentsLink[] = [
                    ...
                    links: [
                        {
                            ...
                            url: '/shop',
                            links: [
                                {title: 'Focos Delanteros', url: '/shop'},
                                {title: 'Focos Traseros', url: '/shop'},
                                {title: 'Focos para niebla', url: '/shop'},
                                {title: 'Luces de Giro', url: '/shop'},
    ...
    {title: 'Interior', url: '/shop'},
    {title: 'Alimentación combustible', url: '/shop'},
    {title: 'Dirección', url: '/shop'},
    {title: 'Suspencion', url: '/shop'},
    {title: 'Chasis', url: '/shop'},
    {title: 'Transmision', url: '/shop'},
    {title: 'Filtros de Aire', url: '/shop'},
];
