...
function makeProducts(defs: ProductDef[]): Product[] {
    return defs.map(def => {
        ...
        const attributesDef: ProductAttributesDef = {
            Velocidad: [true, '750 RPM'],
            'Fuente de Poder': [true, 'Cordless-Electric'],
            'tipo de batería': [true, 'Lithium'],
            Voltaje: [true, '20 Volts'],
            'Capacidad Batería': [true, '2 Ah'],
...
const productsDef: ProductDef[] = [
    {
        name: 'Soporte de Goma - Reajuste Freno',
    ...
    {
        name: 'Juego de Zapatas de Freno - Trasera',
    ...
    {
        name: 'Tapa del Depósito del Líquido de Freno',
    ...
    {
        name: 'Sensor de Desgaste - Disco de Freno',
    ...
    {
        name: 'Barra Reguladora de Freno - Trasero',
    ...
    {
        name: 'Pieza de Unión Zapata a Freno de Mano',
    ...
    {
        name: 'Unidad de Control de Bloqueo de la Dirección - N26/5',
    ...
    {
        name: 'Tapa - Bomba Hidráulica de Dirección',
    ...
    {
        name: 'Tuerca de fijación - Mecanismo de Dirección',
    ...
    {
        name: 'Juego de Reparación de la Culata del Compresor de Aire',
    ...
    {
        name: 'Motor Compacto - con Culata y Bomba de Aceite',
