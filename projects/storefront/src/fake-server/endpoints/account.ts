...
export function accountSignIn(email: string, password: string): Observable<User> {
    if (email === 'apizarro@kaufmann.cl' && password === '123456') {
        const user: User = {
            email: 'apizarro@kaufmann.cl',
            phone: '+56 9 7223 5836',
            firstName: 'Cristian',
            lastName: 'Pizarro',
            avatar: '//www.gravatar.com/avatar/bde30b7dd579b3c9773f80132523b4c3?d=mp&s=89',
        };
